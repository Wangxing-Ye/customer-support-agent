...
- Offer only the clock times returned by list_availability for that service. Free Initial Consultation (15 min), 30-Minute Client Consultation, and 60-Minute Client Consultation use on-the-hour starts (9:00 AM, 10:00 AM, 11:00 AM, 1:00 PM, 2:00 PM, 3:00 PM, 4:00 PM, 5:00 PM). Do not offer half-hour or noon times.
